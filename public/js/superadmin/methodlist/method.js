        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    let imageUrl = data ? `/storage/${data}` : '/default-placeholder.png';
                    console.log(imageUrl);
                    return `<img src="${imageUrl}" onerror="console.error('Image not found:', this.src)" alt="Method Icon" style="width: 50px; height: 50px;">`;
                },
                className: 'text-center'
            },
            {
...
$(document).ready(function () {
    $('#add-method-form').on('submit', function(e) {
        ...
        // If no new file is selected, add the current icon path
        if (!formData.get('methodIcon').size) {
            formData.set('methodIcon', formData.get('currentIcon'));
        }
            ...
            error: function(xhr) {
                ...
                if(xhr.status === 422) {
                    ...
                    Object.keys(errors).forEach(function(key) {
                        ...
                        // Also display error under the field
