...
<head>
	...
	<link href="{{asset('admin-assets/vendor/nestable2/css/jquery.nestable.min.css')}}" rel="stylesheet">
    ...
    <link rel="stylesheet" data-purpose="Layout StyleSheet" title="Web Awesome" href="/css/app-wa-462758aa1e172f82d39e1ea35e919e0a.css?vsn=d">
    ...
    <link rel="stylesheet" href="https://cdn.datatables.net/select/1.3.3/css/select.dataTables.css">
    <link rel="stylesheet" href="https://cdn.datatables.net/fixedheader/3.2.0/css/fixedHeader.dataTables.css">
    ...
    >
      ...
      >
      <link rel="shortcut icon" href="{{asset('admin-assets/images/login/Untitled_design-removebg-preview.png')}}">
      <link
        rel="stylesheet"
...
<body>
    ...
    <!--*******************
        Preloader start
    ********************-->
  <div id="preloader" style="display:flex; justify-content:center; align-items:center;  ">
        <div class="sk-three-bounce" style="display:flex; justify-content:center; align-items:center;">
            <video src="{{asset('images\preloader\math.mp4')}}" width="200px" autoplay loop muted></video>
        </div>
    </div>
    <!--*******************
        Preloader end
        ...
        ***********************************-->
        ...
        <div class="nav-header">
            <a href="{{route('home')}}" class="brand-logo">
                ...
                <img class="brand-title" src="{{asset('storage/'.$logo->logo)}}" alt="">
            ...
            <div class="nav-control">
                <div class="hamburger">
                    <span class="line" style="background: linear-gradient(45deg, #28a745, #007bff);"></span><span class="line" style="background: linear-gradient(45deg, #28a745, #007bff);"></span><span class="line" style="background: linear-gradient(45deg, #28a745, #007bff);"></span>
                </div>
            </div>
        </div>
        <!--**********************************
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown" style="background: linear-gradient(45deg, #28a745, #007bff);">
									<div class="header-info">
										<span>Hello, <strong>{{Auth::user()->name}}</strong></span>
									</div>
                                    @if (Auth::user()->image=="")
                                    <img src="{{asset('admin-assets/images/default_profile/user5.gif')}}" width="20" alt="">
                                    @else
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <form action="{{route('logout')}}" method="post" class="dropdown-item ai-icon" >
                                        @csrf
                                        <button type="submit"class="ms-2" style="background-color:white;">
